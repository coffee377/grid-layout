...
export declare type GridType = 'container' | 'item';
export declare type WithFalse<T> = T | false;
export declare type FlowType = 'row' | 'column' | 'row dense' | 'column dense';
export declare type ContentAlignType = 'start' | 'end' | 'center' | 'stretch' | 'space-around' | 'space-between' | 'space-evenly';
export declare type ItemsAlignType = 'start' | 'end' | 'center' | 'stretch';
