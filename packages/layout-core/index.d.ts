...
declare module "css-grid-layout/specification" {
  ...
  export type GridArea = (itemData: ItemData) => string
  export type Mount = (gridData: GridData, inline?: boolean, document?: Document) => Element;
  export type Create = (gridData: GridData, inline?: boolean, format?: boolean) => string;
  export type Style = (gridData: GridData) => Record<string, CSSProperties>;

}

declare module "css-grid-layout/core" {
  // import ItemData = CssGridLayout.ItemData;
  // import GridData = CssGridLayout.GridData;
   ...
   * @param document
   */
  export function mount(gridData: GridData, inline?: boolean, document?: Document): Element;
